...
1. [Formal Proposal & Commercial Budget (v1.0)](file:///c:/Desarrollo/Erp/docs/project_proposal_and_budget.md)
...
2. [Definitive Functional Specification — Frozen Scope (v1.0)](file:///c:/Desarrollo/Erp/docs/functional_specification.md)
...
3. [Domain Model & Entity Architecture (v1.0)](file:///c:/Desarrollo/Erp/docs/domain_model.md)
...
4. [Consolidated Backlog, Sprint Roadmap & Budget (v1.0)](file:///c:/Desarrollo/Erp/docs/mvp_backlog.md)
   ...
   - **Single-Developer Estimation**: 52 Man-Days total (~2.5 months).
   - **10-Sprint Execution Plan**: 1-week iterative sprints delivering functional milestones.

5. [Technical Stack & Architecture (v1.0)](file:///c:/Desarrollo/Erp/ERP/docs/tech_stack.md)
...
6. [Detailed Sprint Plan (v1.0)](file:///c:/Desarrollo/Erp/ERP/docs/sprint_plan.md)
...
7. [Low-Fidelity Wireframes (v1.0)](file:///c:/Desarrollo/Erp/ERP/docs/wireframes/_index.md)
...
8. [Git Workflow & Branch Strategy (v1.0)](file:///c:/Desarrollo/Erp/ERP/docs/git_workflow.md)
