...
| S0-T15 | #26          | Crear README del proyecto con badges e instrucciones                                                | Docs     | ✅ Cerrada |

### ✅ Definition of Done — Sprint 0

- [x] `docker compose up -d` levanta sin errores
- [x] `pnpm --filter @erp/backend run start:dev` arranca NestJS en `:3000`
- [x] `GET http://localhost:3000/api/v1/health` responde `200 OK`
- [x] `pnpm --filter @erp/frontend run dev` arranca Vite en `:5173` y muestra el layout base
- [x] `pnpm -r run lint` pasa sin errores
- [x] CI pipeline pasa en GitHub Actions
...
### US-01 — Autenticación y Gestión de Sesión _(1 día)_
...
### US-02 — Administración de Usuarios y Auditoría Inmutable _(1.5 días)_
...
### US-03 — CRUD de Categorías y Unidades de Medida _(1 día)_
...
### US-04 — Catálogo de Productos y Factores de Conversión _(2 días)_
...
### US-05 — Consulta y Búsqueda de Productos _(1 día)_
...
### US-07 — Backend-Enforcement de Stock No Negativo _(1.5 días)_
...
### US-08 — Movimientos Manuales y Alertas de Stock Bajo _(1 día)_
...
### US-09 — Carga Inicial Masiva de Inventario _(1.5 días)_
...
### US-10 — Gestión de Stock Retenido / Cuarentena _(1.5 días)_
...
### US-11 — CRUD de Proveedores _(1 día)_
...
### US-12 — Diccionario de Códigos Producto ↔ Proveedor _(1.5 días)_
...
### US-13 — Subida, Mapeo Dinámico y Plantillas por Proveedor _(3 días)_
...
### US-14 — Previsualización, Validaciones y Resolución de Desconocidos _(2.5 días)_
...
### US-15 — Crear y Gestionar Órdenes de Compra _(2 días)_
...
### US-16 — Registrar Recepción de Mercadería y Conversión a Stock Base _(2.5 días)_
...
### US-17 — Recepción Parcial y Gestión de Backorders _(1.5 días)_
...
### US-18 — Conciliación Recepción ↔ Factura de Proveedor _(2.5 días)_
...
### US-19 — Tolerancia de Costos y Facturas Observadas _(1.5 días)_
...
### US-20 — Algoritmo de Ajuste Retroactivo de Costos _(3 días)_
...
### US-21 — Cálculo de Precio Sugerido y Jerarquía de Markups _(1.5 días)_
...
### US-22 — Bandeja de Revisión de Precios _(1.5 días)_
...
### US-23 — CRUD de Clientes y Límites de Crédito _(1 día)_
...
### US-24 — Precios Especiales y Descuentos por Cliente _(1.5 días)_
...
### US-28 — Devoluciones de Clientes y Control de Calidad _(2 días)_
...
### US-26 — Integración ARCA: Emisión de Comprobantes Fiscales _(4 días)_
...
### US-27 — Manejo de Contingencias y Reconexión ARCA _(2 días)_
...
### US-29 — Cuenta Corriente de Clientes por Movimientos _(2 días)_
...
### US-30 — Cobranzas, Aplicación de Pagos y Emisión de Recibos _(2.5 días)_
...
### US-31 — Ciclo de Vida Completo de Cheques _(2 días)_
...
### US-32 — Reversión Transaccional por Cheque Rechazado _(2 días)_
...
### US-33 — Caja Chica y Arqueo Físico _(1.5 días)_
...
### US-34 — Desglose de Tesorería _(1 día)_
...
### US-35 — Dashboard KPIs _(0.5 días)_
...
### US-36 — Export Engine _(0.5 días)_
...
### US-37 a US-45 — Reportes Operativos _(3 días total)_
...
### US-46 — Configuración General del Sistema _(0.5 días)_
