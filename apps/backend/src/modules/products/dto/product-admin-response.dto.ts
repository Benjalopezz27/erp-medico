...
export class ProductAdminResponseDto {
  ...
  @ApiProperty({
    description: 'Net purchase cost in ARS (Admin only)',
    example: 1500.5,
  })
  costNet: number;

  @ApiPropertyOptional({
    description: 'Target markup percentage (Admin only)',
    example: 35.0,
    nullable: true,
  })
  ...
  @ApiProperty({
    description:
      'Authoritatively calculated suggested selling price in ARS (Admin only)',
    example: 2025.68,
  })
