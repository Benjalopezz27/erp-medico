...
- [x] 8.1 E2E: venta de contado facturable → `POST /sales` → job procesado (ARCA en modo mock/`ARCA_ENV=development` corriendo el processor in-process) → `GET /sales/:id/fiscal-document` devuelve `EMITIDO` con CAE.
